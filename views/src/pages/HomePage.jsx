    ...
    return(
        <>
            ...
            <div className='h-72'>
                ...
                <div className="bg-pattern bg-repeat h-72">
                    <div className='mx-20 pt-16 text-2xl text-neutral-600'>
                        <p className='font-semibold'>Batik is a culture <br /> that must <br /> be preserved.</p>
                        <img src={Line} alt="no-image" className='w-36 -rotate-3 pl-6' />
                    </div>
                </div>
            </div>
            ...
            <section className='bg-neutral-100'>
                <div className="bg-pattern bg-repeat h-40 w-[100%] rounded-lg"></div>

                <div className="px-20 py-36">
                    <div className="grid grid-cols-2">
                        <div className=''>
                            <div className="flex flex-col gap-3">
                                <h1 className='text-5xl text-neutral-700 font-semibold'>One for all</h1>
                                <h1 className='text-5xl text-neutral-700 font-semibold'>solution, for</h1>
                                <h1 className='text-5xl text-neutral-700 font-semibold'>
                            ...
                            <div className='w-3/4 mt-8 text-neutral-500'>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius, voluptate quisquam ipsa fugiat ad ex laborum obcaecati animi excepturi, provident sequi? Aliquam provident ipsa rerum! Voluptatibus illum quas tempore repellat.</p>
                            </div>

                            <div className='mt-8'>
                                <button className='py-2 px-6 border-none bg-yellow-700 text-white text-sm font-semibold rounded-md hover:bg-yellow-800 hover:duration-700'>GET STARTED</button>
                            </div>
                        </div>
            ...
            <section className='mx-20 my-28'>
                <div className="mb-10">
                    <h1 className='text-4xl text-neutral-700'>How <span className='font-bold'>it works.</span></h1>
                </div>
                <div className="grid grid-cols-4 gap-10">
                    <div className="bg-neutral-100 w-full flex flex-col justify-center items-center rounded-lg shadow-md">
                        ...
                        <div className='mt-6 mb-14'>
                            <p className='font-semibold text-neutral-500 text-lg'>Pick your style</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-neutral-100 w-full flex flex-col justify-center items-center rounded-lg shadow-md">
                        ...
                        <div className='mt-6 mb-14'>
                            <p className='font-semibold text-neutral-500 text-lg'>Choose your size for perfect fit</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-neutral-100 w-full flex flex-col justify-center items-center rounded-lg shadow-md">
                        ...
                        <div className='mt-6 mb-14'>
                            <p className='font-semibold text-neutral-500 text-lg'>Checkout and choose payment</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-neutral-100 w-full flex flex-col justify-center items-center rounded-lg shadow-md">
                        ...
                        <div className='mt-6 mb-14'>
                            <p className='font-semibold text-neutral-500 text-lg'>Product will be shipped!</p>
                        </div>
                    </div>
            ...
            <section className='bg-neutral-100 px-20'>
                <div className="pt-28 pb-10">
                    <h1 className='text-4xl text-neutral-700'>Recommendation <span className='font-bold'>products.</span></h1>
                </div>
                    {
                        loading ? (
                            <div className="grid grid-cols-4 gap-10 pb-28">
                                {[1, 2, 3, 4].map((n) => {
                                    return(
                                        <div key={n} className="bg-neutral-200 w-full rounded-lg mb-10 shadow-sm animate-pulse">
                                            <div className="overflow-hidden flex justify-center my-8">
                                                <svg className="w-60 h-72 text-neutral-400 bg-neutral-300 p-10 rounded-lg" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg>
                                            </div>
                                    ...
                                    return(
                                        <div key={index} className="bg-white w-full rounded-lg mb-10 shadow-sm">
                                            ...
                                            <div className="content px-7 mb-8">
                                                ...
                                                <div className="mb-1">
                                                    <h2 className='text-lg font-bold text-neutral-700 line-clamp-1'>{items.title}</h2>
                                                </div>
