        ...
        <>
            <section className='h-[100vh]'>
                <div className='bg-pattern h-[100vh] bg-repeat flex justify-center'>
                    <div className='bg-white w-5/6 h-full flex shadow-lg'>
                        ...
                        <div className='h-full w-[70%] flex items-center justify-center bg-neutral-100'>
                            <div className=''>
                                <div className="top-content flex flex-col gap-3 mb-8">
                                    <h1 className='text-4xl font-bold text-neutral-600'>Create your account.</h1>
                                    <p className='text-sm text-neutral-400 font-semibold'>Enter the fields below to get started</p>
                                </div>
                                ...
                                <form action="" onSubmit={handleSubmit}>
                                    ...
                                    <div className='flex flex-col mb-2 gap-1'>
                                        <label htmlFor="phoneNumber" className='text-neutral-700 font-medium'>Phone Number</label>
                                        <input 
                                            className='border border-neutral-300 rounded-md py-0.5 outline-neutral-400 px-2 text-neutral-800'    
                                            type="text" 
                                            name="phoneNumber" 
                                    ...
                                    <input type='submit' className='bg-yellow-700 text-white border-none outline-none cursor-pointer w-full py-1.5 rounded-md hover:bg-yellow-800 hover:ring-2 hover:ring-yellow-700 hover:duration-700' value='Sign In'/>
                                </form>
